...
hold on;
% plot the first run
plot_footpaths(left1.data(:,1), left1.data(:,2), left1.data(:,3),...
...
% plot the second run
plot_footpaths(left2.data(:,1), left2.data(:,2), left2.data(:,3),...
...
% plot the third run
plot_footpaths(left3.data(:,1), left3.data(:,2), left3.data(:,3),...
